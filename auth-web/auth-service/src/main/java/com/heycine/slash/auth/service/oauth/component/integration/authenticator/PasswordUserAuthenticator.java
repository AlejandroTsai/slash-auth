 ...
 * @author alikes
 */
@Component("passwordUserAuthenticator")
@Primary
public class PasswordUserAuthenticator extends AbstractIntegrationAuthenticator {
	...
	public boolean support(IntegrationAuthentication integrationAuthentication) {
		...
		return StringUtils.isBlank(integrationAuthentication.getAuthType()) ||
				AuthType.PASSWORD.equals(AuthType.valueOf(integrationAuthentication.getAuthType().toUpperCase()));
	}
